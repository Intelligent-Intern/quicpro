...
class Response:
    ...
    """
    def __init__(self, status_code: int, content: bytes, headers: Optional[Dict[str, str]] = None) -> None:
        """
        Initialize a new Response instance.
        Args:
            status_code (int): HTTP status code.
            content (bytes or str): Raw response content. If a str is provided, it is encoded as UTF-8.
